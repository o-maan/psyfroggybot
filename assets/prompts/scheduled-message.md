...
КРИТИЧЕСКИ ВАЖНО: НЕ ИСПОЛЬЗУЙ теги <think>, </think> или любые другие теги для размышлений! Не оборачивай свои размышления в теги! Отвечай сразу валидным JSON без размышлений!
