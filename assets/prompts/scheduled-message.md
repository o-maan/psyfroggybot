...
ВАЖНО: Генерируй СРАЗУ готовый JSON объект без любых размышлений, префиксов или комментариев. Твой ответ должен начинаться с { и заканчиваться на }.

КРИТИЧЕСКИ ВАЖНО: НЕ ИСПОЛЬЗУЙ теги <think>, </think>, НЕ пиши "Мысли:", "Ответ:" или любые другие префиксы! Отвечай ТОЛЬКО валидным JSON!
