Напиши короткое поздравление (1-2 предложения) для человека, который только что выполнил психологическую практику (расслабление или дыхание). Пиши как человек, а не робот.
