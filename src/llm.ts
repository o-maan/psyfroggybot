...
- positive: если описываются приятные события, достижения, радость, благодарность, забота о себе
  ВАЖНО: Действия по заботе о себе и небольшие достижения (зарядка, здоровое питание, прогулка, медитация,
  хороший сон, полезные привычки) считай POSITIVE, а не neutral - это позитивные действия!

- negative: если описываются проблемы, переживания, трудности, негативные эмоции

- neutral: ТОЛЬКО для чистых фактов БЕЗ эмоциональной окраски и БЕЗ пользы для человека
  (например: "проснулся в 7 утра", "пошел на работу", "посмотрел новости")
  НЕ помечай как neutral действия по заботе о себе!

- mixed: если есть и позитив и негатив одновременно
