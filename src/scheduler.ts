    ...
    try {
      ...
      if (promptNumber === 4) {
        ...
        const prompt4Examples = [
          ...
          'Ты знаешь, у меня в пруду собеседников толковых не много. Поговори со мной 😅\nА если серьезно - давай заполним вчерашний пробел. Смотри задания в посте выше ☝🏻🗓️',
        ...
        if (cleanedText === 'HF_JSON_ERROR' || !cleanedText) {
          ...
          const fallbackExamples = [
            // Промпт 1 - злюсь
            'Кто-то вчера не сделал задания, что за безобразие! 😠\nЯ весь вечер ждал твой ответ, проверял сообщения, а ты не написал ни слова! 🧐 Надо это исправить, у тебя получится 💪🏻',
            'Ээй! 😤 Ты что, забыл про меня? Я жду-жду, а ты молчишь! 🤐\nВчера весь вечер просидел у экрана в ожидании твоего сообщения 🐸 Давай, возвращайся и сделай задания',
            'Ну что за дела?! 😤 Я жду, а ты молчишь... 🤐\nТак дело не пойдет! Напиши про свой вчерашний день',
            'Ну и ну! 🤨 Задания сами себя не выполнят!\nПомни, что важна регулярность 🗽 Жду твоих новостей с нетерпением',
            'Ай-яй-яй… Так не пойдет! 🐸\nЗадания делаются не для галочки - это помогает тебе лучше понимать себя! Поэтому давай сделаем их 📝',
            'Что за безобразие?! 😠 Я тут сижу, жду... А тебя все нет! 🫠\nВернись к нашей работе, ты сможешь, жду 🗍️',
            // Промпт 2 - расстроен
            'Вижу, что вчерашняя лягуха осталась без ответа 😔 Давай исправим',
            'Ты вчера не поделился своими эмоциями... 😔\nЯ все еще здесь и готов выслушать! Давай наверстаем 🐸',
            'Ох... 🐸 Вчера я так и не дождался твоего ответа... 😔\nДумал, ты напишешь хотя бы пару слов. Так тоскливо, когда ты пропадаешь',
            'Ты знаешь, я немного приуныл ☹️\nВчера от тебя не было ни слова. У тебя все хорошо? Давай вернемся и сделаем задания 📝',
            'Эхх! Вчера ты так и не появился 🥴\nНе забывай про лягуху. Еще можно сделать задания. Постоянство - ключ к успеху 🗝️',
            'Смотрю на невыполненные задания 🗍️ и становится так грустно 😞\nВозвращайся, давай продолжим 👨🏻‍🎓',
            // Промпт 3 - переживаю, забочусь, поддерживаю
            'Помни, что важна регулярность, давай вернемся к заданию, у тебя получится! 🙌🏻',
            'Ты помнишь, что ты - самое важное, что у тебя есть? 🥺\nА для себя нужно постараться! Вернись и сделай задания ✏️ У тебя получится! Я верю в тебя! 🐸',
            'Ой, как же тихо и пусто было вчера без тебя... 💔\nЯ переживаю, когда ты исчезаешь. Ты быстрее увидишь результаты, если будешь продолжать каждый день 👣',
            'Привет! 👋🏻 Вчера ты не ответил, и я весь вечер думал о тебе.\nПросто волнуюсь - все ли в порядке? Работа над собой - это не прямая дорога. Иногда мы останавливаемся, и это тоже часть пути. Давай продолжим вместе? 🐸',
            'Даже если вчера не получилось, сегодня - новая возможность 🙌🏻\nДавай продолжим нашу работу? Я готов начать, когда тебе удобно.\nБез спешки, без давления. Просто ты, я и путь к твоей лучшей жизни 🤩',
            'Вчерашняя тишина меня огорчила... Но знаешь что важно?\nТы можешь продолжить прямо сейчас! Я буду рядом 💚'
          ];
        ...
        // Для вариантов 1-3 прогоняем через промпт 5 (перепроверка)
        const validationPrompt = this.extractPromptSection(angryPromptsFile, 5);
        if (validationPrompt) {
