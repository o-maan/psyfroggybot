    ...
    if (categories.size < 10) {
      ...
      categories.set('КОРОТКИЕ РУГАТЕЛЬСТВА', {
        phrases: new Set(['говно', 'жопа', 'говно жопа', 'говно-жопа', 
                         ...
                         'фигня', 'херня', 'хрень', 'хреновина', 'хернота', 'фигнюшка',
...
function isKeyboardSpam(text: string): boolean {
  ...
  // Проверка на распространенные биграммы
  const commonBigrams = ['ст', 'но', 'то', 'на', 'ен', 'ов', 'ни', 'ра', 'во', 'ко', 
                        'де', 'по', 'ро', 'ре', 'ер', 'ол', 'ор', 'ан', 'ти', 'ал',
                        'ет', 'ес', 'ат', 'ит', 'ль', 'ть', 'ня', 'ля'];
