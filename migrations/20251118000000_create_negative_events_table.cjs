/**
 * Миграция для создания таблицы negative_events
 * Аналогично positive_events, но для негативных событий
 */

exports.up = function (knex) {
  return knex.schema.createTable('negative_events', table => {
...
exports.down = function (knex) {
  return knex.schema.dropTableIfExists('negative_events');
};
